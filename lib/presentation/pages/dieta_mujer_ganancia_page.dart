...
class DietaMujerGananciaPage extends StatefulWidget {
  const DietaMujerGananciaPage({super.key});

  @override
  State<DietaMujerGananciaPage> createState() => _DietaMujerGananciaPageState();
}

class _DietaMujerGananciaPageState extends State<DietaMujerGananciaPage> {
  ...
  Widget build(BuildContext context) {
    ...
    final dieta = dietasGananciaMujer[_dietaSeleccionada];
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            // --- SELECTOR DE DIETAS ---
            Text('Variante de Dieta (2000 kcal)', style: GoogleFonts.outfit(color: Colors.white70, fontSize: 16, fontWeight: FontWeight.bold)),
            const SizedBox(height: 16),
            SingleChildScrollView(
              scrollDirection: Axis.horizontal,
              child: Row(
                children: List.generate(dietasGananciaMujer.length, (index) {
                  final d = dietasGananciaMujer[index];
            ...
            Text('Plan de Volume Diario', style: GoogleFonts.outfit(color: Colors.white, fontSize: 20, fontWeight: FontWeight.bold)),
                  ...
                  children: dieta.cronograma.map((comida) {
                    ...
                    return ExpansionTile(
                      ...
                      children: [
                        ...
                        Text('Porción exacta (Superávit):', style: TextStyle(color: Colors.white70, fontWeight: FontWeight.bold, fontSize: 13)),
                        const SizedBox(height: 4),
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text('${metrics.waterGlasses} de $meta vasos (2.5L)', style: const TextStyle(color: Colors.white, fontSize: 16)),
                  const SizedBox(height: 8),
                  Row(
                    children: [
