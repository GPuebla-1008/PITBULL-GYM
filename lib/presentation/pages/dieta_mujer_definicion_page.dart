...
class DietaMujerDefinicionPage extends StatefulWidget {
  ...
  @override
  State<DietaMujerDefinicionPage> createState() => _DietaMujerDefinicionPageState();
}
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            // --- SELECTOR DE DIETAS ---
            Text('Variante de Dieta (1500 kcal)', style: GoogleFonts.outfit(color: Colors.white70, fontSize: 16, fontWeight: FontWeight.bold)),
            const SizedBox(height: 16),
            ...
            // --- LISTA DE COMPRA ---
            Text('Lista del Supermercado', style: GoogleFonts.outfit(color: Colors.white, fontSize: 20, fontWeight: FontWeight.bold)),
            const SizedBox(height: 8),
            Card(
              color: AppTheme.warmGrey,
              shape: RoundedRectangleBorder(borderRadius: BorderRadius.circular(16)),
            ...
            Expanded(
              child: Column(
                ...
                children: [
                  ...
                  Text('${metrics.waterGlasses} de $meta vasos', style: const TextStyle(color: Colors.white, fontSize: 16)),
                  const SizedBox(height: 8),
                  Row(
                    children: [
