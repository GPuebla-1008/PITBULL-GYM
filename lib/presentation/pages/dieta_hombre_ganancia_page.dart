...
class DietaHombreGananciaPage extends StatefulWidget {
  ...
  @override
  State<DietaHombreGananciaPage> createState() =>
      _DietaHombreGananciaPageState();
}
                  ...
                  children: dieta.cronograma.map((comida) {
                    ...
                    return ExpansionTile(
                      ...
                      children: [
                        ...
                        Text(
                          'Porción exacta (Superávit Masivo):',
                          style: TextStyle(
                            color: Colors.white70,
                            fontWeight: FontWeight.bold,
                            fontSize: 13,
    ...
    return TextField(
      ...
      decoration: InputDecoration(
        ...
        focusedBorder: OutlineInputBorder(
          borderSide: BorderSide(color: Colors.deepOrangeAccent.shade400),
          borderRadius: BorderRadius.circular(8),
        ),
